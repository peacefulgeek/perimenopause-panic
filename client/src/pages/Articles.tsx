  ...
  return (
    <SiteShell>
      <section className="container pt-10 pb-6">
        ...
        <p className="mt-3 text-[var(--brown-soft)] max-w-2xl">
      ...
      <section className="container pb-6">
        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex-1 min-w-[220px]">
            <label className="block ui-sans text-xs uppercase tracking-[0.18em] mb-1 text-[var(--brown-soft)]">
              Search
            </label>
            <input
              type="text"
              ...
              className="w-full bg-[var(--cream)] border border-[var(--brown)] px-3 py-2 ui-sans text-sm focus:outline-none focus:border-[var(--terra-deep)]"
            />
          </div>
          <div>
            <label className="block ui-sans text-xs uppercase tracking-[0.18em] mb-1 text-[var(--brown-soft)]">
            ...
            <select
              ...
              className="bg-[var(--cream)] border border-[var(--brown)] px-3 py-2 ui-sans text-sm focus:outline-none focus:border-[var(--terra-deep)]"
            >
              {cats.map((c) => (
      ...
      <section className="container pb-16">
        {loading && <p className="text-[var(--brown-soft)]">Loading the archive...</p>}
        {!loading && filtered.length === 0 && (
          <p className="text-[var(--brown-soft)]">Nothing matches your filter yet. Try a broader search.</p>
        )}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
          {filtered.map((a) => (
            <Link key={a.slug} href={`/articles/${a.slug}`} className="no-underline text-[var(--brown)]">
              <article className="editorial-card overflow-hidden h-full flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <p className="text-sm mt-2 text-[var(--brown-soft)] flex-1">{a.metaDescription}</p>
